...
export default function App() {
  ...
  return (
    <div className="container">
      <h1>EqualPay</h1>
      <p>একসাথে ঘোরাঘুরি বা খাওয়া-দাওয়ার খরচ সমানভাবে ভাগ করা নিয়ে চিন্তিত? সবার নাম এবং কে কত খরচ করেছে তা যোগ করুন। কে কত টাকা ফেরত পাবে বা কাকে কত দিতে হবে, তার একটি পরিষ্কার তালিকা পেয়ে যাবেন।
<br></br>
আড্ডা হবে প্রাণখুলে, আর হিসাব হবে EqualPay-তে!</p>
